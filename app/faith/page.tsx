        ...
        <section className="flex justify-center min-w-screen">
            <div className="max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
                ...
                <p className="leading-7 [&:not(:first-child)]:mt-6">
                    We believe in the existence of one God, who eternally exists as three persons: the Father, the Son, and the Holy Spirit. He is infinite, all-knowing, all-powerful, all-present, and never changing. His nature is characterized by holiness, justice, and unconditional love..
                </p>
                <h2 className="mt-10 scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight transition-colors first:mt-0">
                    The Bible
                </h2>
